<template>
  <div>
    <div v-if="cart" class="w-full max-w-screen-2xl mx-auto py-12 px-6">
      <h1 class="font-header text-6xl mb-6">Checkout</h1>
      <div class="relative grid lg:grid-cols-2 gap-12">
        <div>
          <div class="sticky top-32 bg-white">
            ...
            >
              ...
              <div class="flex-1 text-base">
                <p class="item-title text-lg font-semibold">{{ item.title }}</p>
                <div class="">
            ...
            <div class="cart-total text-right border-t pt-4">
              <p class="font-semibold my-4">
                Subtotal: {{ currency(cart.cart_total) }}
              </p>
              <div
                v-if="shippingOptions"
              ...
              <p class="font-semibold mt-4">
                Total To Pay: {{ currency(totalPrice) }}
              </p>
            </div>
          </div>
        </div>
